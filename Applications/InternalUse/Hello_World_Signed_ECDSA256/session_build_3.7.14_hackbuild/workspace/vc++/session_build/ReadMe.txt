========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet session_build
========================================================================

AppWizard a créé cette application session_build pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application session_build.


session_build.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé session_build.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
