...
typedef enum
{
/* NOTE: MagicH/L are byte swapped in sb_header below */
/* NOTE: These values are found in rce_private.h in the ROM code.  K_RCE_SECTION_H_DIGITAL_KEY_ECDSA256 */
/* ME14 Requires key id (offset 0, low 4 bits) to be set to 0x6 for RSA2048 */
	MagicH = 0x46495357,
/* ME14 Requires key id (offset 0, low 4 bits) to be set to 0x6 for RSA4096 */
//	MagicH = 0x47495357,
/* ME14 Requires key id (offset 0, low 4 bits) to be set to 0x8 for ECDSA256 */
//	MagicH = 0x48495357,
/* ME13 Requires key id (offset 0, low 4 bits) to be set to 0x4 for ECDSA256 */
//	MagicH = 0x44495357,
