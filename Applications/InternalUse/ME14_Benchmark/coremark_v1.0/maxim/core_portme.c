...
#endif
volatile ee_s32 seed4_volatile = ITERATIONS; // ITERATIONS;
...
/* Porting : Timing functions
   ...
   performance counter etc.
        Sample implementation for standard time.h and windows.h definitions
   included.
*/
...
/* Function : start_time
   ...
   example code)
        or zeroing some system parameters - e.g. setting the cpu clocks cycles
   to 0.
*/
...
/* Function : stop_time
   ...
   benchmark.
        ...
        Implementation may be capturing a system timer (as implemented in the
   example code)
        or other system parameters - e.g. reading the current value of cpu
   cycles counter.
*/
void stop_time(void) { 
  stop_time_val = platform_stop_time(); 
}
/* Function : get_time
