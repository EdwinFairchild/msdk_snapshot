 ...
 *
 * @ingroup INFO */
const char * __API__ ucl_get_version(void);
 ...
 *
 * @ingroup INFO */
const char * __API__ ucl_get_copyright(void);
 ...
 *
 * @ingroup INFO */
const char * __API__ ucl_get_build_date(void);
 ...
 *
 * @ingroup INFO */
const char * __API__ ucl_get_options(void);
#ifdef __cplusplus
}
#endif /* __cplusplus  */
