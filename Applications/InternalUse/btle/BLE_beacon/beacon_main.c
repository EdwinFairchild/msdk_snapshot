...
#define BEACON_APP_PEER_ADDR_DEFAULT 0x00058B440301ull
#if (defined(BEACON_APP_PEER_ADDR) && !(BEACON_APP_PEER_ADDR))
#define BEACON_APP_PEER_ADDR BEACON_APP_PEER_ADDR_DEFAULT
...
#ifndef BEACON_APP_USE_SHORT_PDU
#define BEACON_APP_USE_SHORT_PDU 0
#endif /* BEACON_APP_USE_SHORT_PDU */
...
static const uint8_t beaconAdvDataDisc[] =
{
  ...
  /*! device name */
#if BEACON_APP_USE_LEGACY_PDU || BEACON_APP_USE_SHORT_PDU
  17,                                    /*! length */
#else /* BEACON_APP_USE_LEGACY_PDU || BEACON_APP_USE_SHORT_PDU */
  102,                                    /*! length */
#endif /* BEACON_APP_USE_LEGACY_PDU || BEACON_APP_USE_SHORT_PDU */
...
static void beaconPrivRemDevFromResListInd(dmEvt_t *pMsg)
{
  ...
  if (pMsg->hdr.status == HCI_SUCCESS)
  {
    ...
    if (pCb->dbHdl != APP_DB_HDL_NONE)
    {
      ...
      peerAddr.u64t = BEACON_APP_PEER_ADDR_DEFAULT;
#else /* BEACON_APP_PEER_ADDR */
      peerAddr.u64t = BEACON_APP_PEER_ADDR;
#endif /* BEACON_APP_PEER_ADDR */

      /* clear advertising peer address and its type */
#ifdef BEACON_APP_USE_LEGACY_API
      AppSetAdvPeerAddr(HCI_ADDR_TYPE_PUBLIC, &peerAddr.u8t[0]);
#else /* BEACON_APP_USE_LEGACY_API */
      AppExtSetAdvPeerAddr(DM_ADV_HANDLE_DEFAULT, HCI_ADDR_TYPE_PUBLIC, &peerAddr.u8t[0]);
#endif /* BEACON_APP_USE_LEGACY_API */
    }
  }
}
...
{
#ifndef BEACON_APP_USE_LEGACY_API
  uint8_t advHandle;
#endif /* BEACON_APP_USE_LEGACY_API */
...
#if ((BEACON_APP_ADV_TYPE == DM_EXT_ADV_CONN_UNDIRECT) || (BEACON_APP_ADV_TYPE == DM_ADV_CONN_DIRECT_LO_DUTY))
#if BEACON_APP_USE_LEGACY_API
  AppAdvSetData(DM_ADV_HANDLE_DEFAULT, APP_ADV_DATA_CONNECTABLE, sizeof(datsAdvDataConn), (uint8_t *) datsAdvDataConn, HCI_EXT_ADV_DATA_LEN);
#else /* BEACON_APP_USE_LEGACY_API */
...
#ifdef BEACON_APP_USE_LEGACY_API
  AppSetAdvType(BEACON_APP_ADV_TYPE);
#else /* BEACON_APP_USE_LEGACY_API */
  ...
  /* clear advertising peer address and its type */
#ifdef BEACON_APP_USE_LEGACY_API
  AppSetAdvPeerAddr(DM_ADV_HANDLE_DEFAULT, HCI_ADDR_TYPE_PUBLIC, &peerAddr.u8t[0]);
#else /* BEACON_APP_USE_LEGACY_API */
  AppExtSetAdvPeerAddr(DM_ADV_HANDLE_DEFAULT, HCI_ADDR_TYPE_PUBLIC, &peerAddr.u8t[0]);
#endif /* BEACON_APP_USE_LEGACY_API */
#endif /* BEACON_APP_PEER_ADDR */
