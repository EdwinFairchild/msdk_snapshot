...
extern void DoorHandler(wsfEventMask_t event, wsfMsgHdr_t *pMsg);
extern void DoorHandlerInit(wsfHandlerId_t handlerId);
...
void StackInitDoor(void)
{
  ...
  handlerId = WsfOsSetNextHandler(DoorHandler);
  DoorHandlerInit(handlerId);
}
