...
void PlatformInit(void)
{
    ...
    MXC_GCR->perckcn1 &= ~(MXC_F_GCR_PERCKCN1_BTLE | MXC_F_GCR_PERCKCN1_ICACHED | MXC_F_GCR_PERCKCN1_TRNGD );  // Clear BTLE and ICACHE0 disable
...
void PlatformInit(void)
{
    /* Workaround for ICache CRB issue
     * https://jira.maxim-ic.com/browse/ME14-366 */
    *(uint32_t *)0x40000c00 = 1;
    *(uint32_t *)0x4000040c = (1<<6);
    if ((*(uint32_t *)0x40000c00 & 1) == 0)
    {
        printf("locked\n");
    }
