 ...
 *  \brief  
 *
 *          $Date: 2019-04-05 10:18:09 -0700 (Fri, 05 Apr 2019) $
 *          $Revision: 42211 $
 *
...
#ifndef BLE_APP_USE_LEGACY_SCAN
static const appExtMasterCfg_t scannerExtMasterCfg =
{
  ...
  {
  BLE_APP_SCAN_MODE                        /*! The scan type (active or passive) */
  }
};
