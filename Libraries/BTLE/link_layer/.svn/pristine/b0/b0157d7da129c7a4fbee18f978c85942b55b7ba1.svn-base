...
#ifdef __CROSSWORKS
void BbBleConnSlaveInitSh(void);
#endif /* __CROSSWORKS */
...
#ifdef __CROSSWORKS
uint16_t BbBleInitWhiteListSh(uint8_t numEntries, uint8_t *pFreeMem, uint32_t freeMemSize);
#endif /* __CROSSWORKS */
...
#ifdef __CROSSWORKS
uint16_t BbBleInitPeriodicListSh(uint8_t numEntries, uint8_t *pFreeMem, uint32_t freeMemSize);
#endif /* __CROSSWORKS */
