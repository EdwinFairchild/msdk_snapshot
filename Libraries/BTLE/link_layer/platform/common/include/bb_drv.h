 ...
 *
 *  \return     TRUE if successfully initialized, FALSE if error.
 *
 ...
 *
 *  \return     TRUE if successfully re-initialized, FALSE if error.
 *
 ...
 */
/*************************************************************************************************/
uint32_t BbDrvGetMajorVersion(void);
 ...
 */
/*************************************************************************************************/
uint32_t BbDrvGetMinorVersion(void);
